...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      "group-[.is-user]:[&_a]:text-inherit group-[.is-user]:[&_a]:underline group-[.is-user]:[&_button]:text-inherit",
      "group-[.is-assistant]:w-full group-[.is-assistant]:text-foreground",
      "group-[.is-assistant]:[&_a]:text-foreground group-[.is-assistant]:[&_a]:underline",
